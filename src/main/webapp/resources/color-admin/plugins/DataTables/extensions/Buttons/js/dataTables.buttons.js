...
$.extend( Buttons.prototype, {
	...
	/**
	 * Add a new button
	 * @param {object} config Button configuration object, js string name or function
	 * @param {int|string} [idx] Button index for param to insert the button
	 * @return {Buttons} Self for chaining
	 */
	 ...
	 * @param  {node} node Button node
	 * @param  {array} [buttons] Button array, uses js if not defined
...
// Get data from the table for export - this is plugins to a number of plug-in
