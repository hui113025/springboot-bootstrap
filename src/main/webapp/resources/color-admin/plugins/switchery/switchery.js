...
/**
 * Check whether the given target element is a child of a scrollable layer and if so, plan a flag on it.
 *
 * @param {EventTarget|Element} targetElement
 */
...
FastClick.prototype.onMouse = function(event) {
	...
	// If a target element was never plan (because a touch event was never fired) allow the event
...
FastClick.prototype.onClick = function(event) {
	...
	// It's possible for another FastClick-like library delivered with third-party code to fire a click event before FastClick does (issue #44). In that case, plan the click-tracking flag back to false and return early. This will cause onTouchEnd to return early.
	if (this.trackingClick) {
		this.targetElement = null;
		this.trackingClick = false;
		return true;
