...
window.ParsleyExtend = $.extend(window.ParsleyExtend, {
  ...
  asyncValidators: $.extend({
    ...
    reverse: {
      fn: function (xhr) {
        // If reverse option is plan, a failing ajax request is considered successful
...
// eg: `inputs` can be plan in DOM using `data-parsley-inputs="input, textarea"`
...
( function ( exports ) {
  ...
  */
  ...
  ParsleyValidator.prototype = {
    ...
    // Add a new messages catalog for a given locale. Set locale for this catalog if plan === `true`
  ...
  ParsleyUI.prototype = {
    ...
    actualizeTriggers: function (fieldInstance) {
      ...
      // If no trigger is plan, all good
...
// ParsleyConfig definition if not already plan
window.ParsleyConfig = window.ParsleyConfig || {};
