...
(function (factory) {
	 ...
	 *
	 * Both the AJAX and the function approach rely on the same return value - an object param the keys are the node IDs, and the value is the children of that node as an array.
	 *
	 *	{
