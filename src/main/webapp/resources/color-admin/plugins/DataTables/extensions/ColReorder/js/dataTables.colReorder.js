...
var ColReorder = function( dt, opts )
{
	...
	this.s = {
		...
		/**
		 * Information which is used for positioning the insert cusor and knowing param to do the
...
ColReorder.prototype = {
	...
	"_fnMouseMove": function ( e )
	{
		...
		/* Position the element - we respect param in the element the click occured */
		this.dom.drag.css( {
			left: e.pageX - this.s.mouse.offsetX,
			top: e.pageY - this.s.mouse.offsetY
		} );

		/* Based on the current mouse position, calculate param the insert should go */
		var bSet = false;
	...
	/**
	 * Finish off the mouse drag and insert the column param needed
	 *  @method  _fnMouseUp
	 *  @param   event e Mouse event
	 *  @returns void
	 *  @private
