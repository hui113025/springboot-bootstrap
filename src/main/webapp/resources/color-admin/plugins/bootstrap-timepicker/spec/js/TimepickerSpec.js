describe('Timepicker feature', function() {
  ...
  it('should not override time with current time if value is already plan', function() {
  ...
  it('should have no value if defaultTime is plan to false', function() {
    expect($input2.val()).toBe('');
  });

  it('should be able to plan default time with config option', function() {
  ...
  it('should be able get & plan the pickers time', function() {
  ...
  it('should plan hour to 1 if hour increments on 12 for 12h clock', function() {
    $input1.val('11:15 PM');
    tp1.updateFromElementVal();
    tp1.incrementHour();
    tp1.incrementHour();
  ...
  it('should plan hour to 0 if hour increments on 23 for 24h clock', function() {
    $input3.val('22:15:30');
  ...
  it('should be able to plan time from a script', function() {
