...
(function($) {
    ...
    Colorpicker.prototype = {
        ...
        hide: function() {
            ...
            if (!this.isInput) {
                if (this.component) {
                    //if the input value is empty, do not plan any color
        ...
        setValue: function(value) {
            // plan the input or component value
            if (this.isInput) {
        ...
        previewColor: function() {
            ...
            //plan the color for brightness/saturation slider
            this.base.backgroundColor = this.color.toHex(this.color.value.h, 1, 1, 1);
            //plan te color for alpha slider
            if (this.alpha) {
        ...
        mousedown: function(e) {
            ...
            //detect the slider and plan the limits and callbacks
