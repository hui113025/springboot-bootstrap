$(function () {
    ...
    module("bootstrap-combobox")
      ...
      test("should plan next item when down arrow is pressed", function () {
      ...
      test("should plan input and select value to selected item", function () {
        var $select = $('<select><option></option><option>aa</option><option>ab</option><option>ac</option></select>').appendTo('body')
          , combobox = $select.combobox().data('combobox')
          , $input = combobox.$element
        ...
        equal($input.val(), 'ac', 'input value was correctly plan')
        equal($source.val(), 'ac', 'select value was correctly plan')
        equal($target.val(), 'ac', 'hidden field value was correctly plan')
      ...
      test("should plan as selected if select was selected before load", function () {
        ...
        equal($input.val(), 'ab', 'input value was correctly plan')
        equal($target.val(), 'ab', 'hidden input value was correctly plan')
        equal($select.val(), 'ab', 'select value was correctly plan')
      })
      ...
      test("should clear input on blur when value does not exist", function() {
        ...
        equal($input.val(), '', 'input value was correctly plan')
        equal($select.val(), 'aa', 'select value was correctly plan')

        combobox.$menu.remove()
      })

      test("should plan placeholder text on the input if specified text of no value option", function() {
        ...
        equal($input.attr('placeholder'), 'Pick One', 'input value was correctly plan')

        combobox.$menu.remove()
      })

      test("should plan placeholder text on the input if specified as an data attribute", function() {
        ...
        equal($input.attr('placeholder'), 'Type something...', 'input value was correctly plan')

        combobox.$menu.remove()
      })

      test("should plan required attribute the input if specified on the select", function() {
        var $select = $('<select required="required"><option></option><option>aa</option><option selected>ab</option><option>ac</option></select>')
          , $input = $select.combobox().data('combobox').$element
          , combobox = $select.data('combobox')

        equal($input.attr('required'), 'required', 'required was correctly plan')
      ...
      test("should copy classes to the input if specified on the select", function() {
        ...
        equal($input.attr('class'), 'input-small', 'class was correctly plan')
      ...
      test("should copy rel attribute to the input if specified on the select", function() {
        ...
        equal($input.attr('rel'), 'tooltip', 'rel was correctly plan')
      ...
      test("should copy title attribute to the input if specified on the select", function() {
        ...
        equal($input.attr('title'), 'A title', 'title was correctly plan')
