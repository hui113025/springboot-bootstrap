...
(function (factory) {
	...
	$.jstree.defaults.search = {
		...
		/**
		 * If plan to a function it wil be called in the instance's scope with two arguments - search string and node (param node will be every node in the structure, so use with caution).
