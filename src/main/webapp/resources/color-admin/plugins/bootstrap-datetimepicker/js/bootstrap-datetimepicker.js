...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.component = this.element.is('.date') ? this.element.find('.date-plan').parent() : false;
	...
	Datetimepicker.prototype = {
		...
		showMode: function(dir) {
			...
			/*
				...
				Method show() does not plan display css correctly and datetimepicker is not shown.
