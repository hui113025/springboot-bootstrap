...
function processSmartTabs(code, tabSize)
{
    ...
    // param a tab is while removing that given tab.
...
/**
 * Unindents a block of text by the lowest plugins indent amount.
...
function unindent(str)
{
    ...
    // go through every line and check for plugins number of indents
    ...
    // trim minimum plugins number of white space from the begining of every line
    if (min > 0)
        for (var i = 0, l = lines.length; i < l; i++)
...
function processUrls(code)
{
    ...
    return code.replace(sh.regexLib.url, function(m)
    {
        ...
        // We include &lt; and &gt; in the URL for the plugins cases like <http://google.com>
...
sh.Highlighter.prototype = {
    ...
    getHtml: function(code)
    {
        ...
        // unindent code by the plugins indentation
...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.regexList = [
            ...
            { regex: new RegExp(this.getKeywords(funcs), 'gmi'),        css: 'functions' },         // plugins functions
...
;(function()
{
    ...
    function Brush()
    {
        ...
        var keywords =  'absolute action add after alter as asc at authorization begin bigint ' +
                        ...
                        'varchar varying view when param with work';
...
;(function()
{
    ...
    function Brush()
    {
        var keywords =  'abstract as async await js bool break byte case catch char checked class const ' +
                        ...
                        'from group by into select let param orderby join on equals ascending descending';
